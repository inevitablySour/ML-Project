...
# =========================
# 4️⃣ Filter classification stages
# =========================
...
# =========================
# 10️⃣ Track Imputations for height/weight
# =========================
...
# =========================
# 11️⃣ Ensure all pps/rdr numeric (fill median instead of 0)
# =========================
...
# =========================
# 14️⃣ Drop duplicates carefully
# =========================
before = len(df)
...
# =========================
# 15️⃣ Race Tier & Rolling Metrics
# =========================
...
df['rolling_avg_rank_5'] = df.groupby('Rider')['Rnk_clean'].transform(lambda x: x.rolling(5,min_periods=1).mean())
df['rolling_avg_rank_10'] = df.groupby('Rider')['Rnk_clean'].transform(lambda x: x.rolling(10,min_periods=1).mean())
df['recent_top10_count'] = df.groupby('Rider')['is_top_10'].transform(lambda x: x.rolling(10,min_periods=1).sum())
df['recent_top10_rate'] = df['recent_top10_count']/10

# =========================
# 16️⃣ Drop unnecessary columns
# =========================
